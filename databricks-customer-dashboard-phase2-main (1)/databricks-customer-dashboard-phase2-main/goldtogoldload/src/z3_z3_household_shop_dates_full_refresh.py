...
# MAGIC %md
# MAGIC ### Creating table in hive meta store

# COMMAND ----------

common.create_hive_metastore_table(spark, database = 'customer', table = 'household_shop_dates', location = household_dates_path)
